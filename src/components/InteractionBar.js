...
function InteractionBar(props) {
    ...
    function handleLike(){
        if(likedState){
            axios.delete(`recipes/like?id=${mealId}&isDemo=${isDemo}`)
            .then((res)=>{
                //modify some state
            ...
            axios.post(`recipes/like?id=${mealId}&isDemo=${isDemo}`,
            fullMealJson)
            .then((res)=>{
    ...
    function handleSave(){
        ...
        if(savedState){
            axios.delete(`recipes/save?id=${mealId}&isDemo=${isDemo}`)
            .then((res)=>{
            ...
            axios.post(`recipes/save?id=${mealId}&isDemo=${isDemo}`,
            fullMealJson)
            .then((res)=>{
                setSavedState((prev)=>!prev);
                setRefreshView((prev)=>!prev);
